...
const Completed = ({ completedMeetings, user, fetchCompletedMeetings }) => {
    ...
    <div>
      ...
      <ul style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
        {completedMeetings.map((meeting) => {
          console.log(meeting, "completed meeting data>>>>")
          !completedMeetings && console.log("completed meetings not available")
          return (
